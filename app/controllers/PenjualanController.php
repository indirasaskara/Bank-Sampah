...
class PenjualanController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				penjualan.nama_pengepul LIKE ? OR 
				penjualan.alamat LIKE ? OR 
				penjualan.telpon LIKE ? OR 
				penjualan.jenis_sampah_id LIKE ? OR 
				penjualan.berat LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_pengepul","alamat","telpon","jenis_sampah_id","berat","total","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","nama_pengepul","alamat","telpon","jenis_sampah_id","berat","total","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama_pengepul' => 'required',
