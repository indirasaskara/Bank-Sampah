...
class UserController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				user.name LIKE ? OR 
				user.email LIKE ? OR 
				user.email_verified_at LIKE ? OR 
				user.password LIKE ? OR 
				user.telpon LIKE ? OR 
				user.alamat LIKE ? OR 
				user.foto LIKE ? OR 
				user.role LIKE ? OR 
				user.remember_token LIKE ? OR 
				user.created_at LIKE ? OR 
				user.updated_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","email_verified_at","password","telpon","alamat","foto","role","remember_token","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","email_verified_at","telpon","alamat","foto","role","remember_token","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
