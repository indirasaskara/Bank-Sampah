                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-telpon"  value="<?php  echo $this->set_field_value('telpon',""); ?>" type="text" placeholder="Enter Telpon"  required="" name="telpon"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-role"  value="<?php  echo $this->set_field_value('role',""); ?>" type="number" placeholder="Enter Role" step="1"  required="" name="role"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
